...
namespace RiverWeb.Utils
{
    ...
    public class AsynchronousSocketUtility
    {
        // Thread signal
        public static ManualResetEvent allDone = new ManualResetEvent(false);
        // Client  sockets ( "<user id>,<room id>" --> socket )
        public Dictionary<string, Socket> workSocket = new Dictionary<string, Socket>();

        public AsynchronousSocketUtility()
        {
        }
